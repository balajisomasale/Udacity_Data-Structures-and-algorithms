...
def is_user_in_group(user, group):
    ...
    #If I return the value as u said.. I get this error after running: AttributeError: 'list' object has no attribute 'groups' 
    #Align Intendation here
    #for name in group:
    #    if user in name.get_users():
    #       return True
        
      #  for group in group.groups():
     #      if is_user_in_group(user, group.groups):
    #          return True
